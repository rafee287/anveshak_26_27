...
if img_orig is None:
    ...
    # --- CHANGES ADDED HERE: Otsu's Binarization ---
    # We pass 0 as the threshold because Otsu calculates the real value for us!
    calculated_thresh_value, binary_zoomed = cv2.threshold(
        gray_zoomed, 
        0, 
        255, 
    ...
    print(f"Otsu automatically calculated the ideal threshold at: {calculated_thresh_value}")
    ...
    for cnt in contours_zoomed:
        ...
        if not touches_edge:
            ...
            if area > 50 and length < 1000: #and area < 2000:
