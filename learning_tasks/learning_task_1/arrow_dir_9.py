...
def process_arrow(img_path):
    ...
    for cnt in contours_cropped:
        ...
        if not touches_edge and h > 0:
            ...
            # --- UPDATED FILTER: Area, Length, and Aspect Ratio (1 to 4) ---
    ...
    if len(valid_contours) > 0:
        ...
        if M_cropped["m00"] != 0:
            ...
            # cv2.imshow("Debug 6: Distance Transform Heatmap", cv2.normalize(dist_transform, None, 0, 1.0, cv2.NORM_MINMAX))
            # cv2.waitKey(0)
...
# The 6 files you want to process
image_files = [
